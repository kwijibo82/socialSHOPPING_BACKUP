...
<script type="text/javascript">demoSetBodyLayout();</script>
	...
	<section class="container">
		...
		<section class="row-fluid">
			<h3 class="box-header">Headings</h3>
			<div class="box">
				<div class="well">
		...
		<!-- Lead body copy
			================================================== -->
		<section class="row-fluid">
			<h3 class="box-header">Lead body copy</h3>
			<div class="box">
		...
		<!-- Blockquotes
			================================================== -->
		<section class="row-fluid">
			<h3 class="box-header">Blockquotes</h3>
			<div class="box">
				...
				<div class="well clearfix">
					...
					<blockquote>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
						<small>Some <cite title="">Famous Person</cite></small>
					</blockquote>
		...
		<!-- ================================================== -->
		<section class="row-fluid">
			<h3 class="box-header">Lists</h3>
			<div class="row-fluid">
				<!-- Unordered list
					================================================== -->
				<div class="box span4">
					<p>
						Urdered list <code>&lt;ul&gt;</code>.
					</p>
					<ul>
				...
				<div class="box span4">
					<p>
						Remove the <code>list-style</code> and left padding by adding <code>.unstyled</code> class.
					</p>
					<ul class="unstyled">
						<li>Facilisis in pretium nisl aliquet</li>
						<li>
		...
		<section class="row-fluid">
			...
			<div class="span6">
				...
				<div class="box">
					<p>Terms with their associated descriptions.</p>
					<dl>
						<dt>First desctiption</dt>
						<dd>A description list is perfect for defining terms.</dd>
						<dt>Next description</dt>
						<dd>Vestibulum id ligula porta felis euismod semper eget lacinia odio sem nec elit.</dd>
						<dd>Donec id elit non mi porta gravida at eget metus.</dd>
						<dt>Another one description</dt>
			...
			<!-- Horizontal description
				================================================== -->
			<div class="span6">
				<h3 class="box-header">Horizontal description</h3>
				<div class="box">
