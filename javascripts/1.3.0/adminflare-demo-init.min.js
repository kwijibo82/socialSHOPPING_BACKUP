var DEMO_ADMINFLARE_VERSION = "1.3.0", DEMO_CURRENT_LAYOUT = "default", DEMO_CURRENT_THEME = "default";
...
}, demoCapitaliseFirstLetter = function (a) {
    return a.charAt(0).toUpperCase() + a.slice(1)
}, demoGetColor = function (a) {
    return (a === "default" || a === "black-blue") ? "blue" : ((a === "cyan" || a === "black-cyan") ? "cyan" : ((a === "green" || a === "black-green") ? "green" : ((a === "orange" || a === "black-orange") ? "orange" : ((a === "red" || a === "black-red") ? "red" : "pink"))))
},
