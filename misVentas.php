...
<script type="text/javascript">demoSetBodyLayout();</script>
			...
			<div class="well widget-pie-charts">
				...
				<div class="box no-border non-collapsible">
					...
					<div class="span2 pie-chart">
						...
						<div class="caption">
							Exito <!--Si preguntan qué es el Exito (sitema de créditos) en Altagora que explique Xavi, este comentario no va de broma ;) -->
						</div>
					</div>
				</div>
			</div>
	...
	<!--	<section class="row-fluid" id="supported-browsers">
			<div class="box">
				...
				<div class="span10">
					<div>
						<img src="assets/images/browsers/chrome.png" alt="Google Chrome">
						<span>Chrome</span>
					</div>
					<div>
						<img src="assets/images/browsers/firefox.png" alt="Mozills Firefox 9+">
						<span>Firefox 4+</span>
					</div>
					<div>
						<img src="assets/images/browsers/safari.png" alt="Safari 5+">
						<span>Safari 5+</span>
					</div>
					<div>
						<img src="assets/images/browsers/opera.png" alt="Opera 10+">
						<span>Opera 11+</span>
					</div>
					<div>
						<img src="assets/images/browsers/ie.png" alt="Internet Explorer 9+">
						<span>IE 9+</span>
					</div>
				</div>
			</div>
		...
		<footer id="main-footer">
			Copyright © 2013 <a href="#">Altagora/a>, all rights reserved.
